...
class HistoriqueCinetpayTrans extends StatefulWidget {
  ...
  HistoriqueCinetpayTrans({Key key, @required this.child}) : super(key: key);

  @override

  _HistoriqueCinetpayTransState createState() => _HistoriqueCinetpayTransState();
}
...
class _HistoriqueCinetpayTransState extends State<HistoriqueCinetpayTrans> {
  ...
  void getCynetpayTransactions() async {
    ...
    var res = await CallApi().getData('getCinetpayTrans');
