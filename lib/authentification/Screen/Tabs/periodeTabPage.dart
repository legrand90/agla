...
class PeriodeTabPage extends StatefulWidget {

  final Widget child ;

  PeriodeTabPage({Key key, @required this.child}) : super(key: key);

  @override
  _PeriodeTabPageState createState() => _PeriodeTabPageState();
}

class _PeriodeTabPageState extends State<PeriodeTabPage> {
      ...
      body: Form(
          child: ListView(
            children: <Widget>[
              ...
              Container(
                child: Center(
                  child: Text('INFORMATIONS PERIODE'),
                ),
              ),
