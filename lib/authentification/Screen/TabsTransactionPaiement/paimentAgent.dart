...
class PaimentAgent extends StatefulWidget {

  final Widget child ;

  PaimentAgent({Key key, @required this.child}) : super(key: key);

  @override

  _PaimentAgentState createState() => _PaimentAgentState();
}

class _PaimentAgentState extends State<PaimentAgent> {
