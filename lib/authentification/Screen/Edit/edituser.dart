...
class EditUser extends StatefulWidget {
  var idUser;
  EditUser({Key key, @required this.idUser}) : super(key: key);
  @override
  _EditUserState createState() => new _EditUserState(idUser);
}

class _EditUserState extends State<EditUser> {
  var idUser;
  _EditUserState(this.idUser);
  ...
  Future <String> UpdateUser() async{
    ...
    var id_user = localStorage.getInt('ID');
      ...
      var data = {
        ...
        'email': _email.text,
        'date': date,
        'id_lavage': defaultLavage ? searchVal : idlav,
        'admin': defaultAdmin ? _mySelection2 : admin,
