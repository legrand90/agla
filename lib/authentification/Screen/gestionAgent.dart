...
class GestionAgent extends StatefulWidget {

  @override

  _GestionAgentState createState() => _GestionAgentState();
}

class _GestionAgentState extends State<GestionAgent> {
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('GESTION AGENT', textAlign: TextAlign.center,),
      ),
      body: load ? Center(
        child: new Container(
