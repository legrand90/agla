...
import 'package:lavage/authentification/Screen/Edit/editlavage.dart';
...
class ListLavages extends StatefulWidget {


  @override
  _ListLavagesState createState() => _ListLavagesState();
}

class _ListLavagesState extends State<ListLavages> {
  ...
  void DeleteLavage() async {
    SharedPreferences localStorage = await SharedPreferences.getInstance();
    var id = localStorage.getString('id_lavage');

    var res = await CallApi().postDataDelete('delete_lavage/$idlavag');
          ...
          itemBuilder: (_,int index)=>ListTile(
                ...
                IconButton(
                  ...
                  onPressed: ()async{
                   ...
                   await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => EditLavage(idLav: lavages.data [index] .id,),
                        ));
                   setState(() {
                     load = true;
                   });
                    ...
                    Future<bool> _sureToDelete(){
                      return showDialog(
                          ...
                          builder: (context) => AlertDialog(
                            title: Text("Voulez-vous vraiment supprimer le lavage " + " \"${lavages.data[index].libelleLavage}\"" + "  de la liste des lavages ?"),
                            actions: <Widget>[
                              FlatButton(
                                child: Text("Non"),
            ...
            onTap: ()async{
             ...
             await Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => DetailsLavage(idlav: lavages.data[index].id),
                  ));
             setState(() {
               load = true;
             });
